...
LOOKUP = {'GND_PERSON': {'url': 'https://lobid.org/gnd/search?format=json:suggest&filter=type:Person&q=',
                         'mapping': GND_MAPPING,
                         'filter': None,
                         ...
                         'resourceid_prefix': '',
                         'source_name': 'GND'},
          'VIAF_PERSON': {'url': 'http://www.viaf.org/viaf/AutoSuggest?query=',
                          'mapping': VIAF_MAPPING,
                          'filter': {'nametype': 'personal'},  
                          'result': 'result',
                          'resourceid_prefix': 'http://www.viaf.org/viaf/',
                          'source_name': 'VIAF'},
          'FAIL': {'url': 'http://httpstat.us/500',
                   'mapping': {},
                   'filter': None,
                   'result': None, 
                   'resourceid_prefix': '',
    ...
    'GND_PLACE': { 'url': 'https://lobid.org/gnd/search?format=json:suggest&filter=type:PlaceOrGeographicName&q=',
                   'mapping': GND_MAPPING,
                   'filter': None,
                   'result': None,
                   'resourceid_prefix': '',
                   'source_name': 'GND'},
    'VIAF_PLACE':  {'url': 'http://www.viaf.org/viaf/AutoSuggest?query=',
                    'mapping': VIAF_MAPPING,
                    'filter': {'nametype': 'geographic'},
                    'result': 'result',
                    'resourceid_prefix': 'http://www.viaf.org/viaf/',
                    'source_name': 'VIAF'},
    'GEONAMES_PLACE': {'url': 'http://api.geonames.org/search?maxRows=10&username=***REMOVED***&type=json&q=',
