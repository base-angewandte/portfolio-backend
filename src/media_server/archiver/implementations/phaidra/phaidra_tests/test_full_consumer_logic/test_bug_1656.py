"""
# Portfolio–Phaidra BE: Contributors are missing in Phaidra for certain types
...
class NotThesisContributorsTestCase(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        Create entry with type "Article"
        Add contributors with roles
        Add and archive an asset
        """
        ...
        if response.status_code != 200:
            raise RuntimeError(f'Can not perform test. Media Archival returned status code {response.status_code}'
